package org.ossmeter.metricprovider.trans.githubstars.model;
...
public class Stargazers extends Pongo {
	...
	public Stargazers() { 
		super();
		LOGIN.setOwningType("org.ossmeter.metricprovider.trans.githubstars.model.Stargazers");
		DATESTAMP.setOwningType("org.ossmeter.metricprovider.trans.githubstars.model.Stargazers");
	}
