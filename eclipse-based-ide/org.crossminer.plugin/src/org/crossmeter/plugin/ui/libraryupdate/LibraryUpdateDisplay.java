...
import org.crossmeter.plugin.ui.libraryupdate.provider.LibraryNameLabelProvider;
import org.crossmeter.plugin.ui.libraryupdate.provider.LibraryTreeContentProvider;
import org.crossmeter.plugin.ui.libraryupdate.provider.LibraryVersionLabelProvider;
...
public class LibraryUpdateDisplay extends TitleAreaDialog implements IDisposable {
	...
	protected Control createDialogArea(Composite parent) {
		...
		setTitleImage(ResourceManager.getPluginImage("org.crossmeter.plugin", "icons/CROSSMINER-logo-small.png"));
	...
	private ImageDescriptor createImageDescriptor() {
		return ImageDescriptor.createFromImage(ResourceManager.getPluginImage("org.crossmeter.plugin",
				"icons/bulb.png"));
	}
