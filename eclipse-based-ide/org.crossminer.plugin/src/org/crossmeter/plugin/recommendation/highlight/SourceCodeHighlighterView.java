...
import org.crossmeter.plugin.ui.abstractmvc.AbstractView;
...
public class SourceCodeHighlighterView extends AbstractView {
	...
	public static final String MARKER_ID = "org.crossmeter.plugin.markers.sourcecodehighlight";
	...
	private String buildMessage(IHighlightable highlightable) {
		...
		return "CROSSMETER Source Replace Highlight:\n"
